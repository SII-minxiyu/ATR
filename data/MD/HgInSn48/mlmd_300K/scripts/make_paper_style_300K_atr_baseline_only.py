...
def plot_metric(system_name: str, target_T: float, series: dict[str, dict[str, np.ndarray]], metric: str, ylabel: str) -> None:
    ...
    png = OUT_DIR / f"{system_name}_300K_ATR_vs_Baseline_{metric}.png"
    pdf = OUT_DIR / f"{system_name}_300K_ATR_vs_Baseline_{metric}.pdf"
...
def main() -> None:
    ...
    print(f"wrote ATR-vs-Baseline figures to: {OUT_DIR}")
