...
SETTINGS = {
    "MODEL_LABEL": "7net-omni-mp_r2scan",
    "DATA_DIR": ".",
    "OUTPUT_DIR": "./7net-omni-mp_r2scan/pred_xyz_single",
    "FIRST_IDX": 0,
    "LAST_IDX": 22,
    "ONLY_FINAL_STEP": False,
    "SEVENNET_MODEL": "7net-omni",
    "SEVENNET_FILE_TYPE": None,
    "SEVENNET_MODAL_CANDIDATES": ["mp r2scan", "mp_r2scan"],
    ...
    "XYZ_INDEX": ":",
    "SKIP_LOG": "./7net-omni-mp_r2scan/skipped_xyz.txt",
}
